...
import Category from "../components/UI/cartegory/Category.jsx";
...
import TestimonialSlider from "../components/UI/slider/TesttimonialSlider.jsx";
const featureData = [
  {
            ...
            <Col lg="6" md="6">
              <div className="hero__content  ">
                ...
                <div className="hero__btns d-flex align-items-center gap-5">
                  ...
                  <button className="all__foods-btns">
